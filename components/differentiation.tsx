      ...
      <div className="container px-4 md:px-6">
        <div className="text-center space-y-4 mb-12">
          <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">
            <span className="text-[#217346]">익숙한 툴</span>을 활용한 스마트한
            선택
          </h2>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="relative">
            {/* Process flow */}
            <div className="absolute left-[18px] top-0 h-full w-1 bg-[#217346]"></div>

            <div className="space-y-12">
              <ProcessStep
                number={1}
                title="기존 엑셀 파일 연결"
                description="현재 사용 중인 엑셀 파일을 ClassFlow에 연결합니다. 데이터 구조를 변경할 필요가 없습니다."
              />

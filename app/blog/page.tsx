...
async function BlogList({ page = 1 }: { page?: number }) {
  const pageSize = 9;
  const { blogs, error, total } = await getBlogList();
  console.log(blogs);
  if (error) {
      ...
      <div className="container px-4 md:px-6">
        <div className="mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-3xl">
            ...
            사례를 확인하세요. 실제 사용자들의 경험과 성공 스토리를 통해
            ClassFlow와가 어떻게 학원 운영을 개선하는지 알아보세요.
          </p>
        </div>
